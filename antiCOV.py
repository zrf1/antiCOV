...
class Doctor(object):
    ...
    def _right_face(self):
        ...
        self.t.seth(60)
        self._draw_curve(1.5, 20, -0.012, 5)
        self.t.rt(30)
        self._draw_curve(2.3, 20, 0.04, 6)
        self.t.seth(-118)
    ...
    def _left_ear(self):
        ...
        self.t.fillcolor(self._get_color('skin'))
        self.t.begin_fill()
        self._draw_curve(0.5, 36, 0.02, -5)
        self._goto(-43, 41)
        self.t.end_fill()
    ...
    def _right_ear(self):
        ...
        self.t.seth(190)
        self._draw_curve(3, 10, -0.015, -10)
        self.t.lt(60)
        self._draw_curve(1.5, 16, -0.05, -15)
    ...
    def _hair(self):
        ...
        self.t.seth(60)
        self._draw_curve(1.5, 13, -0.012, 5)
        self._goto(88, 51)
        self.t.end_fill()
    ...
    def _yifu_kd_kz(self):
        ...
        self._goto_up(9, -123)
        self.t.seth(-90)
        self._draw_ellipse(0.36, 0.01, 3)
    ...
    def _draw_curve(self, _d, r, dd, angle):
        '画曲线'
        tracer(False)
        d = _d
        for i in range(1, r):
    ...
    def _draw_ellipse(self, d, dd, angle):
        '画椭圆'
        tracer(False)
        d = d
        for i in range(120):
...
class Nurse(object):
    ...
    def _ears(self):
        ...
        self._goto(82, 40)
        self.t.seth(0)
        self._draw_curve(0.1, 32, 0.1, 5.1)
        self.t.pu()
        self._goto(72, 33)
        self.t.end_fill()
        self.t.pd()
...
if __name__ == "__main__":
    ...
    docter = Doctor(t, 150, -30)
    nurse = Nurse(t, -150, -90)
    docter.draw()
    nurse.draw()
